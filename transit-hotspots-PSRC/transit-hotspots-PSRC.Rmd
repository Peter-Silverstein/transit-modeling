...
csv_file <- unzip(here("geo-files", "Household_Travel_Survey_Trips.csv.zip"), 
                  files = "Household_Travel_Survey_Trips.csv")
psrc_trips <- tibble(read.csv(here(csv_file)) %>%
...
# Deleting the unzipped PSRC csv file
invisible(file.remove(here("Household_Travel_Survey_Trips.csv")))
```
...
## Preliminary Choropleth Map: Mass Transit Trips as a Percentage of Total Trips
